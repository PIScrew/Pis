	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<!-- End Slider -->
				<!-- User admin -->
				<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('admin/useradmin')?>"
					 aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">User admin</span></a></li>
				<!-- end user admin -->
				<!-- Pengaturan -->
				<li class="sidebar-item">
					<a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
